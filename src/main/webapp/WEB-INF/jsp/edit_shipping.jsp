			...
			$('#myform4').validate({
				...
				submitHandler:function(form){
			        ...
			        $.ajax({
						"async":false,
						"type": "POST",
						"url": "${pageContext.request.contextPath }/updateship",
						"data" : data,
						"success" : function(data) {
							if(data){
								layer.msg("修改收货地址成功！",{icon:1,anim:2,time:2000},function(){
									window.location.href = "${pageContext.request.contextPath }/showshippinginfo";
								});
							}else{
								layer.msg("修改收货地址失败！",{icon:5,anim:6,time:3000});
							}
						},
						"dataType":"json"
					}); 
			...
			<div class="row">
				...
				<div class="col-md-8 col-xs-8">
					<div
						...
						<p style="font-size: 15px; text-align: center">修改收货地址</p>
						<div>&nbsp;</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="receiver_name"
										name="receiver_name" placeholder="请输入收货人姓名" value="${ship.receiver_name }">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="receiver_phone"
										name="receiver_phone" placeholder="请输入手机号码" value="${ship.receiver_phone }">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-8 col-xs-8">
									<input type="text" class="form-control" id="receiver_address"
										name="receiver_address" placeholder="请输入街道、门牌号、小区等" value="${ship.receiver_address }">
								</div>
							</div>
