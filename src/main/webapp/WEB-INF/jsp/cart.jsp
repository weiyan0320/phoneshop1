        ...
        <c:if test="${!empty cart.cartMap}">
			...
			<div class="row">
                ...
                <script type="text/javascript">
                   ...
                   {
                	   layer.confirm("你确定要删除该商品？",function(){
                	   ...
                	   if(str=="")
               		   {
               		       ...
               		       layer.msg('至少选择一种商品！', { icon: 5, shade: 0.4, time: 2000 });
               		   }else
           			   {
	               			layer.confirm("你确定要删除所选商品？",function(){
						...
						<tbody>
							...
							<c:forEach items="${cart.cartMap}" var="entry">
								...
								<td style="vertical-align:middle">
								    <button type="button" class="btn btn-danger" onclick="delCartItem('${entry.key }')">删除</button>
								</td>
							</tr>
         ...
         <div class="container">
	           <div class="row" >
	               <!-- 删除选中商品的信息 -->
	               <div>
	                  <button type="button" class="btn btn-danger" onclick="deleteCheckedProduct()">删除选中商品</button>
	               </div>
