			...
			submitHandler:function(form){
		        ...
		        $.ajax({
					...
					"success" : function(data) {//对后台返回的json数据进行处理
						if(data.code=="00"){
							//注册成功
							layer.msg("注册成功,请登录",{icon:1,anim:2,time:2000},function(){
								window.location.href = "${pageContext.request.contextPath }/login";//跳转到登陆页面
							});
						}else{
							layer.msg("注册失败,"+data.message,{icon:5,anim:6,time:3000});
							//显示错误信息
