...
import com.ping.service.IEvaluateService;
...
public class ProductController {
	...
	public String selectProductInfo(@RequestParam int pid,Model model)
	{
		...
		List<Evaluate> evaList = evaluateService.findEvaluateByPid(pid);
		model.addAttribute("evaList", evaList);//商品评价信息
	...
	public String selectProductInfoListByInput(String searchContent,@RequestParam(defaultValue="1") int currentPage,Model model )
	{
		...
		PageBean pageBeanProduct=productService.selectProductInfoListByInput(searchContent,currentPage,currentCount);
