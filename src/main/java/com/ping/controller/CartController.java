...
//		cartItem.setSubTotal(subTotal);
		cartItem.setSubTotal(new BigDecimal(subTotal).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());
...
//			cartItem.setSubTotal(newSubTotal);
			cartItem.setSubTotal(new BigDecimal(newSubTotal).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());
