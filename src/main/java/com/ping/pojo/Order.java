...
public class Order {
	...
	private int status;         //-1删除 1 待付款 2待发货 3 待收货 4待评价 5完成
	private String receiver_name; //收货人的姓名
	private String receiver_phone; //收货人的电话
	private String receiver_address; //收货人的地址
	
	private int payment_status;//支付状态 1代表已付款，0代表未付款
	
	private String express_no;//物流订单号
	...
	private String order_username;//订单所属用户
